...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>prizeSDK Documentation :: Sample Instant Win with Multiple Prizes Game</title>
    ...
    <body id="main_body" >
        ...
        <div id="content_container">
            ...
            <h1>prizeSDK</h1>
            <div id="bodycontent">
                <h2>Sample Instant Win with Multiple Prizes Game</h2>
<?php
...
if ($game = $prizeSDK->enterInstantWin($userdata)) {
    ...
    ?>
                    ...
                    <?php if ($game['game_is_winner'] == 1) { ?>
                        ...
                        <?php if ($game['win_level'] == 6) { /* For custom messages dependent on the level, check win_level. */ ?>
                                <p>Congratulations, you have won the grand prize, <?php echo $game['result_text'] ?>. Please come back and play again tomorrow. </p>
                            <?php } else if ($game['win_level'] == 5 || $game['win_level'] == 4) { ?>
                                <p>Congratulations, you have won one of the sponsored prizes, <?php echo $game['result_text'] ?>. Please come back and play again tomorrow. </p>
                            <?php } else { ?>
